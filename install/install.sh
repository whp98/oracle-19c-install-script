...
cp ./ora-response/db_install.rsp.tmpl ./ora-response/db_install.rsp
sed -i -e "s|###ORACLE_BASE###|$ORACLE_BASE|g" ./ora-response/db_install.rsp
sed -i -e "s|###ORACLE_HOME###|$ORACLE_HOME|g" ./ora-response/db_install.rsp
sed -i -e "s|###ORACLE_EDITION###|$ORACLE_EDITION|g" ./ora-response/db_install.rsp
chown oracle:oinstall -R $ORACLE_BASE
current_path=$(pwd)
su -l oracle -c "yes | $ORACLE_HOME/runInstaller -silent -ignorePrereqFailure -waitforcompletion -responseFile $current_path/ora-response/db_install.rsp"
$ORACLE_BASE/oraInventory/orainstRoot.sh
$ORACLE_HOME/root.sh
rm ./ora-response/db_install.rsp
...
cp ./ora-response/dbca.rsp.tmpl ./ora-response/dbca.rsp
sed -i -e "s|###ORACLE_SID###|$ORACLE_SID|g" ./ora-response/dbca.rsp
sed -i -e "s|###ORACLE_PDB###|$ORACLE_PDB|g" ./ora-response/dbca.rsp
sed -i -e "s|###ORACLE_CHARACTERSET###|$ORACLE_CHARACTERSET|g" ./ora-response/dbca.rsp
sed -i -e "s|###ORACLE_PWD###|$ORACLE_PWD|g" ./ora-response/dbca.rsp
sed -i -e "s|###EM_EXPRESS_PORT###|$EM_EXPRESS_PORT|g" ./ora-response/dbca.rsp

# Create DB
su -l oracle -c "dbca -silent -createDatabase -responseFile $current_path/ora-response/dbca.rsp"
...
sudo cp ./scripts/setPassword.sh /home/oracle/
...
#         echo "INSTALLER: Done running $f"
#         ;;
#       ./userscripts/put_custom_scripts_here.txt)
#         :
#         ;;
#       *)
